...
python3 run_cnn.py --model_name $MODEL_DIR/vgg_fp_64 $TEST_ARGS --full_prec --no_filt_vgg 64,64,64,64,64,64,64,128,128,24 --test_output $MODEL_DIR/vgg_fp_64/test_$snr"_snr.csv"
