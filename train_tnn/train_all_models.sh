...
# Vgg bin 64
python3 run_cnn.py --model_name $MODEL_DIR/vgg_twn_nu_1.2_0.7_bin_64 $TRAIN_ARGS --twn_binary_act --nu_conv 1.2 --nu_dense 0.7 --no_filts 64,64,64,64,64,64,64,128,128,24
