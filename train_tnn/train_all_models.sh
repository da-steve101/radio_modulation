...
python3 run_cnn.py --model_name $MODEL_DIR/vgg_fp_64_d512 --dataset $DATA_DIR/modulation_classification_resnet_train.rcrd \
--steps $STEPS --batch_size $BATCH_SIZE --learning_rate $LR --full_prec --gpus $GPUS --val_dataset $DATA_DIR/modulation_classification_test_snr_30.rcrd \
--no_filt_vgg 64,64,64,64,64,64,64,512,512,24 --teacher_dset
# vgg fp 128
python3 run_cnn.py --model_name $MODEL_DIR/vgg_fp_128 --dataset $DATA_DIR/modulation_classification_resnet_train.rcrd \
--steps $STEPS --batch_size $BATCH_SIZE --learning_rate $LR --full_prec --gpus $GPUS --val_dataset $DATA_DIR/modulation_classification_test_snr_30.rcrd \
--no_filt_vgg 128,128,128,128,128,128,128,512,512,24 --teacher_dset
#custom Vgg
...
--nu_conv 1.2 --nu_dense 0.7 --no_filt_vgg 64,64,64,64,64,64,64,512,512,24 --teacher_dset
...
--steps $STEPS --batch_size $BATCH_SIZE --learning_rate $LR --twn --gpus $GPUS --val_dataset $DATA_DIR/modulation_classification_test_snr_30.rcrd \
--nu_conv 1.2 --nu_dense 0.7 --no_filt_vgg 96,96,96,96,96,96,96,512,512,24 --teacher_dset
...
--steps $STEPS --batch_size $BATCH_SIZE --learning_rate $LR --twn --gpus $GPUS --val_dataset $DATA_DIR/modulation_classification_test_snr_30.rcrd \
--nu_conv 1.2 --nu_dense 0.7 --no_filt_vgg 128,128,128,128,128,128,128,512,512,24 --teacher_dset
#custom Vgg
...
python3 run_cnn.py --model_name $MODEL_DIR/vgg_twn_nu_1.2_0.7_bin_64_d512 --dataset $DATA_DIR/modulation_classification_resnet_train.rcrd \
--steps $STEPS --batch_size $BATCH_SIZE --learning_rate $LR --twn_binary_act --gpus $GPUS --val_dataset $DATA_DIR/modulation_classification_test_snr_30.rcrd \
--nu_conv 1.2 --nu_dense 0.7 --no_filt_vgg 64,64,64,64,64,64,64,512,512,24 --teacher_dset
# Vgg bin 128
