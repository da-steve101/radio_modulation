...
export MODEL_DIR=../models/vgg_twn_nu_1.2_0.7_f128
...
rsync -aP $MODEL_DIR/*_hex.sv ../verilog_test/tw_vgg_2iq_test.sv tuna:~/rt_amc_models/f128/sim/
rm $MODEL_DIR/*_hex.sv
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq_bin.sv tuna:~/rt_amc_models/f128/srcs/
