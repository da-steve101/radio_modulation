...
export MODEL_DIR=../models/vgg_twn_nu_1.2_0.7_bin_64_d512
...
python3 generate_test_vecs.py $MODEL_DIR/conv_img_lyr4.csv $MODEL_DIR/conv4_hex.sv OUT 0 16
python3 generate_test_vecs.py $MODEL_DIR/dense_bn_relu_img_lyr1.csv $MODEL_DIR/dense_1_bn_hex.sv OUT 0 1
python3 generate_test_vecs.py $MODEL_DIR/dense_bn_relu_img_lyr2.csv $MODEL_DIR/dense_2_bn_hex.sv OUT 0 1
...
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq.sv tuna:~/rt_amc_models/bin64_d512/srcs/
