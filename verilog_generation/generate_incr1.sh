...
export MODEL_DIR=../models/vgg_twn_nu_1.2_0.7_incr1_128

python3 generate_bn_vecs.py $MODEL_DIR/vgg_bn_lyr1_a_b.csv $MODEL_DIR/bn1.sv 1 14 16 1 1 1
python3 generate_bn_vecs.py $MODEL_DIR/vgg_bn_lyr2_a_b.csv $MODEL_DIR/bn2.sv 2 8 16 2 3 2
python3 generate_bn_vecs.py $MODEL_DIR/vgg_bn_lyr3_a_b.csv $MODEL_DIR/bn3.sv 3 8 16 4 15 4
python3 generate_bn_vecs.py $MODEL_DIR/vgg_bn_lyr4_a_b.csv $MODEL_DIR/bn4.sv 4 8 16 8 255 8
...
python3 generate_test_vecs.py $MODEL_DIR/dense_bn_relu_img_lyr1.csv $MODEL_DIR/dense_1_bn_hex.sv OUT 0 1
python3 generate_test_vecs.py $MODEL_DIR/dense_img_lyr1.csv $MODEL_DIR/dense_1_hex.sv OUT 0 16
python3 generate_test_vecs.py $MODEL_DIR/dense_img_lyr2.csv $MODEL_DIR/dense_2_hex.sv OUT 0 16
python3 generate_test_vecs.py $MODEL_DIR/pred_output.csv $MODEL_DIR/dense_3_hex.sv OUT 6 16

python3 generate_tw_vgg10.py $MODEL_DIR 16,1,1,1,1,1,1 16,16,16,16,16,1,1 n,p,p,p,p,s,s

rsync -aP $MODEL_DIR/*_hex.sv ../verilog_test/tw_vgg_2iq_incr_test.sv tuna:~/rt_amc_models/incr1/sim/
rm $MODEL_DIR/*_hex.sv
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq.sv --exclude tw_vgg_2iq_bin.sv tuna:~/rt_amc_models/incr1/srcs/
