...
python3 generate_bn_vecs.py --file_in $MODEL_DIR/vgg_bn_dense_1_a_b.csv --file_out $MODEL_DIR/bnd1.sv --bn_id 1 --rshift $BN_PREC --bw_in 16 --bw_out 1 --maxval 1
python3 generate_dense_vecs.py --file_in $MODEL_DIR/vgg_dense_1.csv --file_out $MODEL_DIR/dense_1.sv --lyr 1 --bw_w 2 --tput 2
python3 generate_bn_vecs.py --file_in $MODEL_DIR/vgg_bn_dense_2_a_b.csv --file_out $MODEL_DIR/bnd2.sv --bn_id 2 --rshift $BN_PREC --bw_in 16 --bw_out 1 --maxval 1
