...
export MODEL_DIR=../models/vgg_twn_nu_1.2_0.7_f64
...
rsync -aP $MODEL_DIR/*.sv ../verilog/*.sv --exclude tw_vgg.sv --exclude tw_vgg_2iq_bin.sv tuna:~/rt_amc_models/f64/srcs/
